...
document.getElementById("btn-ej7").addEventListener("click", function () {
  const out = document.getElementById("out-ej7"); // <-- Salida opcional
  ...
  fetch("https://jsonplaceholder.typicode.com/users/2")
    ...
    .then(function (u) {
      ...
      document.getElementById("ej7-city").textContent =
        (u.address && u.address.city) ? u.address.city : "-";

      if (out) out.textContent = "DOM ACTUALIZADO";
      console.log("Ej7 OK:", u);
    })
    .catch(function (err) {
      console.error(err);
...
document.getElementById("btn-ej8").addEventListener("click", async function () {
  const out = document.getElementById("out-ej8"); // <-- Salida opcional
  if (out) out.textContent = "CARGANDO...";
  ...
  try {
    ...
    document.getElementById("ej8-city").textContent =
      (u.address && u.address.city) ? u.address.city : "-";

    if (out) out.textContent = "DOM ACTUALIZADO";
    console.log("Ej8 OK:", u);
